...
import * as userPhotosApi from '../../src/api/userPhotos'
import * as itemsApi from '../../src/api/items'
import * as tryonApi from '../../src/api/tryon'
