...
import { Outfits } from '../../src/pages/Outfits'

vi.mock('../../src/hooks/useSavedOutfits', () => ({
...
import * as savedOutfitsHook from '../../src/hooks/useSavedOutfits'
import * as itemsHook from '../../src/hooks/useItems'
